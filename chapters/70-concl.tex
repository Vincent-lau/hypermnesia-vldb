...
\begin{itemize}
  ...
  \item Hypermnesia chooses to use pure op-based \acrshortpl{crdt} for its simplicity
  and similarity to Mnesia's architecture. \acrshortpl{dcrdt} is another popular
